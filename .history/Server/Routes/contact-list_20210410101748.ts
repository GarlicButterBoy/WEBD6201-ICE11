...
import { DisplayAddPage, DisplayContactListPage, DisplayEditPage, ProcessAddPage, ProcessEditPage } from '../Controllers/contact-list';
...
router.get('/delete/:id', ProcessDe);
